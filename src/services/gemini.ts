...
export async function generateAnswer(
  ...
  const prompt = `
    Com base no texto fornecido abaixo como contexto, responda a pergunta de forma clara e precisa em portuguê do Brasil.
    ...
    - Se a resposta não for encontrada no contexto, apenas responda que não possui informações suficients para responder;
    - Seja objetivo;
